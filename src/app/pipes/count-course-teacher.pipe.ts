...
@Pipe({
  name: 'countCourseTeacher'
})
export class CountCourseTeacherPipe implements PipeTransform {
  stateService = inject(StateService);

  transform(courseId: string, teacherId: string, planIds: Array<string>): number {
